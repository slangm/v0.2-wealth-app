...
export interface ProtectedSavingsVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "baseYieldBps",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "boosterBps",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "currentYieldBps",
    values: [AddressLike]
  ): string;
  ...
  decodeFunctionResult(functionFragment: "boosterBps", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "convertToAssets",
    data: BytesLike
  ): Result;
...
export namespace BoosterUpdatedEvent {
  export type InputTuple = [user: AddressLike, newBonusBps: BigNumberish];
  export type OutputTuple = [user: string, newBonusBps: bigint];
  export interface OutputObject {
    user: string;
    newBonusBps: bigint;
  }
...
export interface ProtectedSavingsVault extends BaseContract {
  connect(runner?: ContractRunner | null): ProtectedSavingsVault;
  waitForDeployment(): Promise<this>;

  interface: ProtectedSavingsVaultInterface;
  ...
  baseYieldBps: TypedContractMethod<[], [bigint], "view">;

  boosterBps: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  currentYieldBps: TypedContractMethod<[user: AddressLike], [bigint], "view">;
  ...
  setBooster: TypedContractMethod<
    [user: AddressLike, bonusBps: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  withdraw: TypedContractMethod<
    [assets: BigNumberish, receiver: AddressLike, owner_: AddressLike],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "baseYieldBps"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "boosterBps"
  ...
  getFunction(
    nameOrSignature: "currentYieldBps"
  ...
  getEvent(
    ...
    BoosterUpdatedEvent.InputTuple,
    BoosterUpdatedEvent.OutputTuple,
    BoosterUpdatedEvent.OutputObject
  >;
  getEvent(
    key: "Deposit"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "BoosterUpdated(address,uint16)": TypedContractEvent<
      BoosterUpdatedEvent.InputTuple,
      BoosterUpdatedEvent.OutputTuple,
      BoosterUpdatedEvent.OutputObject
    >;
    BoosterUpdated: TypedContractEvent<
      BoosterUpdatedEvent.InputTuple,
      BoosterUpdatedEvent.OutputTuple,
      BoosterUpdatedEvent.OutputObject
    >;
    ...
    "YieldHarvested(uint256)": TypedContractEvent<
      YieldHarvestedEvent.InputTuple,
      YieldHarvestedEvent.OutputTuple,
      YieldHarvestedEvent.OutputObject
    >;
